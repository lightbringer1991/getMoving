    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.SET_DEFAULT, default=1, to='dash.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Tile_Data',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('dataId', models.ForeignKey(to='dash.Tile_Data')),
                ('tileId', models.ForeignKey(to='dash.Tile')),
            ],
        ),
    ]
